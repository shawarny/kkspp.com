...
$result = "SELECT upload FROM file_hotelnhomestay";
...
<html>
<head>
<title>Muat Naik Hotels & Homestay</title>
...
<div>
<form action ="engine_upload_hotelnhomestay.php" method="post" autocomplete="off" enctype="multipart/form-data">
<caption><b>Muat Naik Hotels & Homestay</b></caption>
<br>
<br>
<style>
			table {
