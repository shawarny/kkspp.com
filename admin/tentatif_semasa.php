...
$result = "SELECT upload FROM file_tentatif";
...
<html>
<head>
<title>Muat Naik Tentatif Semasa</title>
...
<div>
<form action ="engine_upload_tentatif.php" method="post" autocomplete="off" enctype="multipart/form-data">
<caption><b>Muat Naik Tentatif Semasa</b></caption>
<br>
<br>
<style>
			table {
