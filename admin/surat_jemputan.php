...
$result = "SELECT upload FROM file_surat_jemputan";
...
<html>
<head>
<title>Muat Naik Surat Jemputan</title>
...
<div>
<form action ="engine_upload_surat_jemputan.php" method="post" autocomplete="off" enctype="multipart/form-data">
<caption><b>Muat Naik Surat Jemputan</b></caption>
<br>
<br>
<style>
			table {
