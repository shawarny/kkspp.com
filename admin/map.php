...
$result = "SELECT upload FROM file_map";
...
<div>
<form action ="engine_upload_map.php" method="post" autocomplete="off" enctype="multipart/form-data">
<caption><b>Muat Map</b></caption>
<br>
<br>
<style>
			table {
