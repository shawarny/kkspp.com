...
$result = "SELECT * FROM staff where table_id = ".($_REQUEST['id'])."";
$output=mysql_query($result) or die(mysql_error());
$row=mysql_fetch_array($output);
$result2 = "SELECT * FROM staff where table_id = ".($_REQUEST['id'])."";
...
<form method="post" action="engine_admin_view_penyelaras.php">
<table border="1">
		<tr>
			<td>Nama :</td>
