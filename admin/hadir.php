...
$result = "SELECT upload FROM file_hadir";
...
<html>
<head>
<title>Muat Naik Garis Panduan Hadir</title>
...
<div>
<form action ="engine_upload_hadir.php" method="post" autocomplete="off" enctype="multipart/form-data">
<caption><b>Muat Naik Garis Panduan Hadir</b></caption>
<br>
<br>
<style>
			table {
